...
const CREATE_INPUT = {
  alternateMobileNo: "exampleAlternateMobileNo",
  companyName: "exampleCompanyName",
  createdAt: new Date(),
  email: "exampleEmail",
  followUp: new Date(),
  id: "exampleId",
  industryType: "exampleIndustryType",
  ...
  test("POST /leads", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        followUp: CREATE_RESULT.followUp.toISOString(),
      ...
      .expect([
        {
          ...
          followUp: FIND_MANY_RESULT[0].followUp.toISOString(),
  ...
  test("GET /leads/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        followUp: FIND_ONE_RESULT.followUp.toISOString(),
